...
const Contact = () => {
  ...
  return (
    <div className="container mx-auto mt-10">
      <div className="max-w-lg mx-auto my-10 bg-white p-8 rounded-lg shadow-lg dark:bg-gray-800">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-6">
            ...
            <input
              type="text"
              id="name"
              className="w-full px-4 py-2 border rounded-lg text-gray-700 focus:outline-none focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200"
