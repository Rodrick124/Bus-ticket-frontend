...
export default function Footer(){
  return (
    <footer className="mt-12 bg-white border-t dark:bg-gray-800 dark:border-gray-700">
      <div className="max-w-7xl mx-auto px-4 py-6 flex flex-col md:flex-row justify-between items-start gap-4">
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">Smart Travel. Easy Booking.</p>
        </div>
